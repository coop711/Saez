---
title: "US Top Income Share 1913 ~ 2017 (Plots)"
author: "coop711"
date: "`r Sys.Date()`"
...
# png(file = "../pics/US_top_income_share_10_2017_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_10_2017_300dpi_en.png", width = 1280, height = 720)
x.lab <- "Year"
y.lab <- "Income Shares (%)"
...
main.title<- "Top 10% US Income Share (1917 ~ 2017)"
...
text(x = c(1935, 1965, 2017), y = c(48.5, 32, 46.5), label = times.label, cex = 1.0, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_1-4-5_2017_en.png", width = 960, height = 540)
# dev.off()
```
...
# png(file = "../pics/US_top_income_share_1-4-5_2017_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_1-4-5_2017_300dpi_en.png", width = 1280, height = 720)
x.lab <- "Year"
y.lab <- "Income Shares (%)"
...
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.1 <- c("Top 1% (incomes above $423,090 in 2017)", "Top 5-1% (incomes between $174,240 and $423,090)", "Top 10-5% (incomes between $121,360 and $174,240)")
legend(x = 1940, y = 25, legend = legend.text.1, pch = 17, col = c("black", "red", "blue"))
main.title.1 <- "Decomposing the Top 10% US Income Share (1913 ~ 2017)"
title(main = main.title.1)
text(x = c(1924, 2007), y = c(23.5, 23.5), labels = c("1928", "2007"), pos = 3)
times.label <- c("The Great\nDepression", "The Great\nProsperity", "The Great\nRecession")
text(x = c(1935, 1965, 2017), y = c(22, 8, 18), label = times.label, cex = 1.0, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_1-4-5_2017_en.png", width = 960, height = 540)
# dev.off()
```
...
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2017_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2017_300dpi_en.png", width = 1280, height = 720)
...
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.2 <- c("Top 0.1% (incomes above $1,894,100 in 2017)", "Top 0.5-0.1% (incomes between $646,550 and $1,894,100)", "Top 1-0.5% (incomes between $423,090 and $646,550)")
legend(x = 1936, y = 13, legend = legend.text.2, pch = 17, col = c("black", "red", "blue"))
main.title.2 <- "Decomposing the Top 1% US Income Share (1913 ~ 2017)"
title(main = main.title.2)
text(x = c(1924, 2007), y = c(11, 12.5), labels = c("1928", "2007"), pos = 3)
text(x = c(1935, 1965, 2017), y = c(10, 2, 8), label = times.label, cex = 1.0, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_0.1-0.4-0.5_2017_en.png", width = 960, height = 540)
# dev.off()
```
...
# png(file = "../pics/US_top_income_share_0.01-0.09_2017_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_0.01-0.09_2017_300dpi_en.png", width = 1280, height = 720)
...
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.3 <- c("Top 0.01% (incomes above $9,497,900 in 2017)", "Top 0.1-0.01% (incomes between $1,894,100 and $9,497,900)")
legend(x = 1934, y = 6.95, legend = legend.text.3, pch = 17, col = c("black", "blue"))
main.title.3 <- "Decomposing the Top 0.1% US Income Share (1913 ~ 2017)"
title(main = main.title.3)
text(x = c(1924, 2007), y = c(6.3, 6.3), labels = c("1928", "2007"), pos = 3)
text(x = c(1935, 1965, 2017), y = c(5.6, 0.5, 3.4), label = times.label, cex = 1.0, col = "red")
# dev.print(png, file = "../pics/US_top_income_share_0.01-0.09_2017_en.png", width = 960, height = 540)
# dev.off()
```
...
# f6
f7 <- f6 + 
  annotate("text", x = c(1935, 1965, 2017), y = c(48.5, 32, 46.5), label = times.label, colour = "red", size = 4)
```

```{r, Top 10 percent share ggsave, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75}
f7
# ggsave("../pics/US_top_income_share_10_2017_ggplot_en.png", width = 12, height = 6.75)
```
...
g13
# ggsave("../pics/US_top_income_share_1-4-5_2017_ggplot_en.png", width = 12, height = 6.75)
```
...
h13
# ggsave("../pics/US_top_income_share_0.1-0.4-0.5_2017_ggplot_en.png", width = 12, height = 6.75)
```
...
j13
# ggsave("../pics/US_top_income_share_0.01-0.09_2017_ggplot_en.png", width = 12, height = 6.75)
```
