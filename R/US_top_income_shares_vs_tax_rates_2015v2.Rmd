...
top.income_tax$P99_100_z <- z(top.income_tax$P99_100)
top.income_tax$Marginal_z <- z(top.income_tax$Marginal)
Rate_99_z <- z(Rate_99)
Rate_1_z <- z(Rate_1)
Rate_99_K_z <- z(Rate_99_K)
Rate_1_K_z <- z(Rate_1_K)
```
...
plot(P99_100_z ~ Year, data = top.income_tax, type = "b", pch = 17, axes = FALSE, ann = FALSE, xlim = c(1910, 2020), ylim = c(0, 1))
box()
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
axis(side = 2, at = seq(0, 1, by = 0.25), labels = seq(5, 25, by = 5), las = 1, ylab = "Top Income Share")
mtext("Top Income Share(%)", side = 2, line = 3)
# par(new = TRUE)
lines(Marginal_z ~ Year, data = top.income_tax, type = "l", lty = 2, lwd = 2, col = "red", xlim = c(1910, 2020), ylim = c(0, 1))
axis(side = 4, at = seq(0, 1, by = 0.2), labels = seq(0, 100, by = 20), las = 1)
mtext("Marginal Tax Rates(%)", side = 4, line = 3)
title(main = "Top 1% Income Share and Top Marginal Tax Rate", xlab = "Year")
text(x = 1980, y = 0.8, labels = "Top Marginal Tax Rates", cex = 1.2)
text(x = 1960, y = 0.35, labels = "Top 1% Income Shares", cex = 1.2)
...
par(mar = c(5, 6, 4, 6) + 0.1)
plot(Rate_99_z ~ Year, data = top.income_tax, type = "b", pch = 24, col = "black", bg = "black", axes = FALSE, ann = FALSE, xlim = c(1910, 2020), ylim = c(0, 1))
lines(Rate_1_z ~ Year, data = top.income_tax, type = "b", pch = 24, col = "black", bg = "white")
box()
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
axis(side = 2, at = seq(0, 1, by = 0.25), labels = seq(0, 400, by = 100), las = 1)
ylab.2 <- "Average Income (1913 = 100)"
mtext(ylab.2, side = 2, line = 3)
# mtext(ylab.2, side = 2)
# par(new = TRUE)
lines(Marginal_z ~ Year, data = top.income_tax, type ="l", lty = 2, col = "red", lwd = 2, xlim = c(1910, 2020), ylim = c(0, 1))
axis(side = 4, at = seq(0, 1, by = 0.2), labels = seq(0, 100, by = 20), las = 1)
...
legend("bottomright", legend = c("Bottom 99%", "Top 1%"), pch = 24, col = "black", pt.bg = c("black", "white"), inset = 0.05)
# legend("bottom", legend = c("Bottom 99%", "Top 1%"), pch = 24, col = "black", pt.bg = c("black", "white"))
text(x = 1925, y = 0.9, labels = "Top Marginal Tax Rates", cex = 1.2)
...
par(mar = c(5, 6, 4, 6) + 0.1)
plot(Rate_99_K_z ~ Year, data = top.income_tax, type = "b", pch = 24, col = "black", bg = "black", axes = FALSE, ann = FALSE, xlim = c(1910, 2020), ylim = c(0, 1))
lines(Rate_1_K_z ~ Year, data = top.income_tax, type = "b", pch = 24, col = "black", bg = "white")
box()
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
axis(side = 2, at = seq(0, 1, by = 1/6), labels = seq(0, 600, by = 100), las = 1)
