...
text(x = c(1935, 1965, 2014), y = c(22, 8, 18), label = times.label, cex = 1.0, col = "red")
...
plot(P99.9_100 ~ Year, data = US.top.income.shares.14, xlab = x.lab, ylab = y.lab, ylim = c(0, 13), xaxt = "n", yaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2010, by = 10), labels = seq(1910, 2010, by = 10))
...
legend(x = 1938, y = 13, legend = legend.text.2, pch = 17, col = c("black", "red", "blue"))
...
text(x = c(1935, 1965, 2014), y = c(10, 2, 8), label = times.label, cex = 1.0, col = "red")
...
plot(P99.99_100 ~ Year, data = US.top.income.shares.14, xlab = x.lab, ylab = y.lab, ylim = c(0, 7), xaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2010, by = 10), labels = seq(1910, 2010, by = 10))
...
legend(x = 1938, y = 7, legend = legend.text.3, pch = 17, col = c("black", "blue"))
...
text(x = c(1935, 1965, 2014), y = c(5.6, 0.5, 3.4), label = times.label, cex = 1.0, col = "red")
...
#  annotate("text", x = c(1935, 1960, 2014), y = c(22, 8, 18), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
  annotate("text", x = c(1935, 1965, 2014), y = c(22, 8, 18), label = times.label, colour = "red", size = 4)
...
#  annotate("text", x = c(1935, 1960, 2014), y = c(9, 2, 8), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
  annotate("text", x = c(1935, 1965, 2014), y = c(10, 2, 8), label = times.label, colour = "red", size = 4)
```
...
#  annotate("text", x = c(1935, 1960, 2014), y = c(5.6, 2.8, 3.0), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
  annotate("text", x = c(1935, 1965, 2014), y = c(5.6, 0.5, 3.5), label = times.label, colour = "red", size = 4)
```
