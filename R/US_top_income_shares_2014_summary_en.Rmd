...
# png(file = "../pics/US_top_income_share_10_2014_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_10_2014_300dpi_en.png", width = 1280, height = 720)
x.lab <- "Year"
y.lab <- "Income Shares (%)"
plot(P90_100 ~ Year, data = US.top.income.shares.14, xlab = x.lab, ylab = y.lab, xlim = c(1910, 2020), ylim = c(30, 52), xaxt = "n", type = "b", pch = 17)
...
# legend.text <- "Top 10% (incomes above $121,360 in 2014)")
# legend(x = 1940, y = 25, legend = legend.text, pch = 17, col = "black")
main.title<- "Top 10% US Income Share (1917 ~ 2014)"
...
# dev.copy(png, file = "../pics/US_top_income_share_1-4-5_2014_en.png", width = 960, height = 540)
# dev.off()
```
...
# png(file = "../pics/US_top_income_share_1-4-5_2014_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_1-4-5_2014_300dpi_en.png", width = 1280, height = 720)
x.lab <- "Year"
y.lab <- "Income Shares (%)"
plot(P99_100 ~ Year, data = US.top.income.shares.14, xlab = x.lab, ylab = y.lab, xlim = c(1910, 2020), ylim = c(5, 25), xaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
lines(P95_99 ~ Year, data = US.top.income.shares.14, type = "b", pch = 17, col = "red")
lines(P90_95 ~ Year, data = US.top.income.shares.14, type = "b", pch = 17, col = "blue")
...
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2014_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2014_300dpi_en.png", width = 1280, height = 720)
plot(P99.9_100 ~ Year, data = US.top.income.shares.14, xlab = x.lab, ylab = y.lab, xlim = c(1910, 2020), ylim = c(0, 13), xaxt = "n", yaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
...
# dev.copy(png, file = "../pics/US_top_income_share_0.1-0.4-0.5_2014_en.png", width = 960, height = 540)
# dev.off()
```
...
# png(file = "../pics/US_top_income_share_0.01-0.09_2014_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_0.01-0.09_2014_300dpi_en.png", width = 1280, height = 720)
plot(P99.99_100 ~ Year, data = US.top.income.shares.14, xlab = x.lab, ylab = y.lab, xlim = c(1910, 2020), ylim = c(0, 7), xaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
...
legend(x = 1937, y = 6.95, legend = legend.text.3, pch = 17, col = c("black", "blue"))
...
# dev.print(png, file = "../pics/US_top_income_share_0.01-0.09_2014_en.png", width = 960, height = 540)
# dev.off()
```
...
f7
# ggsave("../pics/US_top_income_share_10_2014_ggplot_en.png", width = 12, height = 6.75)
```
...
g13
# ggsave("../pics/US_top_income_share_1-4-5_2014_ggplot_en.png", width = 12, height = 6.75)
```
...
h13
# ggsave("../pics/US_top_income_share_0.1-0.4-0.5_2014_ggplot_en.png", width = 12, height = 6.75)
```
...
j13
# ggsave("../pics/US_top_income_share_0.01-0.09_2014_ggplot_en.png", width = 12, height = 6.75)
```
