...
library(knitr)
str(US.top.income.shares.14)
kable(US.top.income.shares.14[, 1:8])
```
...
title(main = "미국 소득 상위 10%의 점유율 분할")
text(x = c(1928, 2007), y = c(24, 23.5), labels = c("1928", "2007"), pos = 3)
text(x = c(1935, 1960, 2012), y = c(22, 8, 17.5), label = c("대공황", "대번영", "대침체"), cex = 2.0, col = "red")
```
...
(g7 <- g6 + 
   scale_colour_manual(name = "", values = c("black", "red", "blue"), labels = c("99-100%:$423,090 이상(2014년기준)", "95-99%:$174,240-$423,090", "90-95%:$121,360-$174,240")) +
   scale_fill_manual(name = "", values = c("black", "red", "blue"), labels = c("99-100%:$423,090 이상(2014년기준)", "95-99%:$174,240-$423,090", "90-95%:$121,360-$174,240")))
```
