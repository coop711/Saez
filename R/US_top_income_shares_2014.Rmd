...
(g7 <- g6 + scale_colour_manual(values = c("black", "blue", "red"), labels = c("99-100%:$423,090 이상(2014년기준)","95-99%:$174,240-$423,090","90-95%:$121,360-$174,240")) + scale_fill_manual(values = c("black", "blue", "red"), labels = c("99-100%:$423,090 이상(2014년기준)","95-99%:$174,240-$423,090","90-95%:$121,360-$174,240")))
```
...
```{r, no legends title, warning = FALSE, fig.width=12, fig.height=7}
