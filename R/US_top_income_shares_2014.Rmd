...
library(ggplot2)
(g0 <- ggplot(data.1_10.melt, aes(x = Year, y = Share, colour = Percentiles)) + geom_line() + geom_point(shape=24, aes(fill = Percentiles)) + ylim(5, 25))
```
...
(g7 <- g6 + scale_colour_manual(name = "", values = c("black", "blue", "red"), labels = c("99-100%:$423,090 이상(2014년기준)","95-99%:$174,240-$423,090","90-95%:$121,360-$174,240")) + scale_fill_manual(name = "", values = c("black", "blue", "red"), labels = c("99-100%:$423,090 이상(2014년기준)","95-99%:$174,240-$423,090","90-95%:$121,360-$174,240")))
```
