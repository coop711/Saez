---
title: "US Top Income Share 1913 ~ 2017 (도표)"
author: "coop711"
date: "`r Sys.Date()`"
...
options(digits = 2)
load("US_top_income_shares_2017_add.rda")
ls()
```
...
kable(US_top_income_shares_17[c(11:20, 41:51, 92:103), ])
```
...
# png(file = "../pics/US_top_income_share_10_2017_72dpi_kr.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_10_2017_300dpi_kr.png", width = 1280, height = 720)
par(family = "HCR Dotum LVT")
x.lab <- "연도"
y.lab <- "소득 점유(%)"
plot(P90_100 ~ Year, data = US_top_income_shares_17, xlab = x.lab, ylab = y.lab, xlim = c(1910, 2020), ylim = c(30, 52), xaxt = "n", type = "b", pch = 17)
...
# legend.text <- "Top 10% (incomes above $121,360 in 2017)")
# legend(x = 1940, y = 25, legend = legend.text, pch = 17, col = "black")
main.title <- "미국 상위 10% 소득 점유(1917 ~ 2017)"
title(main = main.title)
text(x = c(1927.5, 2007, 2012.5, 2016.5), y = c(50, 50, 51, 50.5), labels = c("1928", "2007", "2012", "2017"), pos = 3)
times.label <- c("대공황", "대번영", "대침체")
text(x = c(1935, 1965, 2017), y = c(48.5, 32, 46.5), label = times.label, cex = 1.5, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_1-4-5_2017_kr.png", width = 960, height = 540)
dev.off()
```
...
# png(file = "../pics/US_top_income_share_1-4-5_2017_72dpi_kr.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_1-4-5_2017_300dpi_kr.png", width = 1280, height = 720)
par(family = "HCR Dotum LVT")
...
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.1 <- c("99-100%:$461,050 이상(2017년 기준)", "95-99%:$189,280-$461,050", "90-95%:$129,870-$189,280")
legend(x = 1947, y = 25, legend = legend.text.1, pch = 17, col = c("black", "red", "blue"))
main.title.1 <- "미국 상위 10% 소득 점유 분할 (1913 ~ 2017)"
title(main = main.title.1)
text(x = c(1924, 2007), y = c(23.5, 23.5), labels = c("1928", "2007"), pos = 3)
text(x = c(1935, 1965, 2017), y = c(22, 8, 18), label = times.label, cex = 1.5, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_1-4-5_2017_kr.png", width = 960, height = 540)
# dev.off()
```
...
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2017_72dpi_kr.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2017_300dpi_kr.png", width = 1280, height = 720)
par(family = "HCR Dotum LVT")
plot(P99.9_100 ~ Year, data = US_top_income_shares_17, xlab = x.lab, ylab = y.lab, xlim = c(1910, 2020), ylim = c(0, 13), xaxt = "n", yaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
axis(side = 2, at = seq(0, 12, by = 3), labels = seq(0, 12, by = 3))
lines(P99.5_99.9 ~ Year, data = US_top_income_shares_17, type = "b", pch = 17, col = "red")
lines(P99_99.5 ~ Year, data = US_top_income_shares_17, type = "b", pch = 17, col = "blue")
abline(h = seq(0, 12, by = 3), lty = 3)
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.2 <- c("99.9-100%:$2,060,030 이상(2017년 기준)", "99.5-99.9%:$705,400-$2,060,030", "99-99.5%:$461,050-$705,400")
legend(x = 1946, y = 13, legend = legend.text.2, pch = 17, col = c("black", "red", "blue"))
main.title.2 <- "미국 상위 1% 소득 점유 분할 (1913 ~ 2017)"
title(main = main.title.2)
text(x = c(1924, 2007), y = c(11, 12.5), labels = c("1928", "2007"), pos = 3)
text(x = c(1935, 1965, 2017), y = c(10, 2, 8), label = times.label, cex = 1.5, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_0.1-0.4-0.5_2017_kr.png", width = 960, height = 540)
# dev.off()
```
...
# png(file = "../pics/US_top_income_share_0.01-0.09_2017_72dpi_kr.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_0.01-0.09_2017_300dpi_kr.png", width = 1280, height = 720)
par(family = "HCR Dotum LVT")
plot(P99.99_100 ~ Year, data = US_top_income_shares_17, xlab = x.lab, ylab = y.lab, xlim = c(1910, 2020), ylim = c(0, 7), xaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
lines(P99.9_99.99 ~ Year, data = US_top_income_shares_17, type = "b", pch = 17, col = "blue")
abline(h = seq(0, 6, by = 2), lty = 3)
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.3 <- c("99.99-100%:$11,082,000 이상(2017년 기준)", "99.9-99.99%:$2,060,030-$11,082,000")
legend(x = 1945, y = 6.95, legend = legend.text.3, pch = 17, col = c("black", "blue"))
main.title.3 <- "미국 상위 0.1% 소득 점유 분할 (1913 ~ 2017)"
title(main = main.title.3)
text(x = c(1924, 2007), y = c(6.3, 6.3), labels = c("1928", "2007"), pos = 3)
text(x = c(1935, 1965, 2017), y = c(5.6, 0.5, 3.4), label = times.label, cex = 1.5, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_0.01-0.09_2017_kr.png", width = 960, height = 540)
# dev.off()
```
...
library(reshape2)
data.10.df <- US_top_income_shares_17[c("Year", "P90_100")]
data.10 <- US_top_income_shares_17[c("Year", "P99_100", "P95_99", "P90_95")]
data.10.melt <- melt(data.10, id.vars = "Year", measure.vars = c("P99_100", "P95_99", "P90_95"), variable.name = "Percentiles", value.name = "Share")
# str(data.10.melt)
data.1 <- US_top_income_shares_17[c("Year", "P99.9_100", "P99.5_99.9", "P99_99.5")]
...
# str(data.1.melt)
data.01 <- US_top_income_shares_17[c("Year", "P99.99_100", "P99.9_99.99")]
...
library(ggplot2)
source("theme_kr.R")
f0 <- ggplot(data.10.df, aes(x = Year, y = P90_100)) + 
...
# f6
f7 <- f6 + 
  annotate("text", x = c(1935, 1965, 2017), y = c(48.5, 32, 46.5), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
```

```{r, Top 10 percent share ggsave, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75}
f7
# ggsave("../pics/US_top_income_share_10_2017_ggplot_kr.png", width = 12, height = 6.75)
```
...
#  annotate("text", x = c(1935, 1965, 2017), y = c(22, 8, 18), label = times.label, colour = "red", size = 4)

```

```{r, Top 10 percent ggsave, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75}
g13
# ggsave("../pics/US_top_income_share_1-4-5_2017_ggplot_kr.png", width = 12, height = 6.75)
```
...
# h12
h13 <- h12 + 
  annotate("text", x = c(1935, 1960, 2017), y = c(9, 2, 8), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
#  annotate("text", x = c(1935, 1965, 2017), y = c(10, 2, 8), label = times.label, colour = "red", size = 4)
```

```{r, Top 1 percent ggsave, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75}
h13
# ggsave("../pics/US_top_income_share_0.1-0.4-0.5_2017_ggplot_kr.png", width = 12, height = 6.75)
```
...
# j12
j13 <- j12 + 
  annotate("text", x = c(1935, 1960, 2017), y = c(5.6, 2.8, 3.0), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
#  annotate("text", x = c(1935, 1965, 2017), y = c(5.6, 0.5, 3.5), label = times.label, colour = "red", size = 4)
```

```{r, Top 0.1 percent ggsave, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75}
j13
# ggsave("../pics/US_top_income_share_0.01-0.09_2017_ggplot_kr.png", width = 12, height = 6.75)
```
...
```{r, save.image}
# save.image(file = "US_top_income_shares_2017_add.rda")
```
-->
