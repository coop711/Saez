---
title: "US Top Income Share 1913 ~ 2015 (Plots)"
author: "coop711"
date: "`r Sys.Date()`"
...
kable(US.top.income.shares.15[c(11:20, 41:51, 92:103), ])
```
...
# png(file = "../pics/US_top_income_share_10_2015_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_10_2015_300dpi_en.png", width = 1280, height = 720)
x.lab <- "Year"
y.lab <- "Income Shares (%)"
...
# dev.copy(png, file = "../pics/US_top_income_share_1-4-5_2015_en.png", width = 960, height = 540)
# dev.off()
```
...
# png(file = "../pics/US_top_income_share_1-4-5_2015_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_1-4-5_2015_300dpi_en.png", width = 1280, height = 720)
x.lab <- "Year"
y.lab <- "Income Shares (%)"
...
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2015_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2015_300dpi_en.png", width = 1280, height = 720)
plot(P99.9_100 ~ Year, data = US.top.income.shares.15, xlab = x.lab, ylab = y.lab, xlim = c(1910, 2020), ylim = c(0, 13), xaxt = "n", yaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
axis(side = 2, at = seq(0, 12, by = 3), labels = seq(0, 12, by = 3))
lines(P99.5_99.9 ~ Year, data = US.top.income.shares.15, type = "b", pch = 17, col = "red")
lines(P99_99.5 ~ Year, data = US.top.income.shares.15, type = "b", pch = 17, col = "blue")
abline(h = seq(0, 12, by = 3), lty = 3)
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.2 <- c("Top 0.1% (incomes above $1,894,100 in 2015)", "Top 0.5-0.1% (incomes between $646,550 and $1,894,100)", "Top 1-0.5% (incomes between $423,090 and $646,550)")
legend(x = 1936, y = 13, legend = legend.text.2, pch = 17, col = c("black", "red", "blue"))
main.title.2 <- "Decomposing the Top 1% US Income Share (1913 ~ 2015)"
title(main = main.title.2)
text(x = c(1924, 2007), y = c(11, 12.5), labels = c("1928", "2007"), pos = 3)
text(x = c(1935, 1965, 2015), y = c(10, 2, 8), label = times.label, cex = 1.0, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_0.1-0.4-0.5_2015_en.png", width = 960, height = 540)
# dev.off()
```
...
# png(file = "../pics/US_top_income_share_0.01-0.09_2015_72dpi_en.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_0.01-0.09_2015_300dpi_en.png", width = 1280, height = 720)
plot(P99.99_100 ~ Year, data = US.top.income.shares.15, xlab = x.lab, ylab = y.lab, xlim = c(1910, 2020), ylim = c(0, 7), xaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
lines(P99.9_99.99 ~ Year, data = US.top.income.shares.15, type = "b", pch = 17, col = "blue")
abline(h = seq(0, 6, by = 2), lty = 3)
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.3 <- c("Top 0.01% (incomes above $9,497,900 in 2015)", "Top 0.1-0.01% (incomes between $1,894,100 and $9,497,900)")
legend(x = 1934, y = 6.95, legend = legend.text.3, pch = 17, col = c("black", "blue"))
main.title.3 <- "Decomposing the Top 0.1% US Income Share (1913 ~ 2015)"
title(main = main.title.3)
text(x = c(1924, 2007), y = c(6.3, 6.3), labels = c("1928", "2007"), pos = 3)
text(x = c(1935, 1965, 2015), y = c(5.6, 0.5, 3.4), label = times.label, cex = 1.0, col = "red")
# dev.print(png, file = "../pics/US_top_income_share_0.01-0.09_2015_en.png", width = 960, height = 540)
# dev.off()
```
...
library(reshape2)
data.10.df <- US.top.income.shares.15[c("Year", "P90_100")]
data.10 <- US.top.income.shares.15[c("Year", "P99_100", "P95_99", "P90_95")]
data.10.melt <- melt(data.10, id.vars = "Year", measure.vars = c("P99_100", "P95_99", "P90_95"), variable.name = "Percentiles", value.name = "Share")
# str(data.10.melt)
data.1 <- US.top.income.shares.15[c("Year", "P99.9_100", "P99.5_99.9", "P99_99.5")]
...
# str(data.1.melt)
data.01 <- US.top.income.shares.15[c("Year", "P99.99_100", "P99.9_99.99")]
...
# f6
f7 <- f6 + 
  annotate("text", x = c(1935, 1965, 2015), y = c(48.5, 32, 46.5), label = times.label, colour = "red", size = 4)
```

```{r, Top 10 percent share ggsave, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75}
f7
# ggsave("../pics/US_top_income_share_10_2015_ggplot_en.png", width = 12, height = 6.75)
```
...
#  annotate("text", x = c(1935, 1960, 2015), y = c(22, 8, 18), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
  annotate("text", x = c(1935, 1965, 2015), y = c(22, 8, 18), label = times.label, colour = "red", size = 4)

```

```{r, Top 10 percent ggsave, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75}
g13
# ggsave("../pics/US_top_income_share_1-4-5_2015_ggplot_en.png", width = 12, height = 6.75)
```
...
# h12
h13 <- h12 + 
#  annotate("text", x = c(1935, 1960, 2015), y = c(9, 2, 8), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
  annotate("text", x = c(1935, 1965, 2015), y = c(10, 2, 8), label = times.label, colour = "red", size = 4)
```

```{r, Top 1 percent ggsave, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75}
h13
# ggsave("../pics/US_top_income_share_0.1-0.4-0.5_2015_ggplot_en.png", width = 12, height = 6.75)
```
...
# j12
j13 <- j12 + 
#  annotate("text", x = c(1935, 1960, 2015), y = c(5.6, 2.8, 3.0), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
  annotate("text", x = c(1935, 1965, 2015), y = c(5.6, 0.5, 3.5), label = times.label, colour = "red", size = 4)
```

```{r, Top 0.1 percent ggsave, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75}
j13
# ggsave("../pics/US_top_income_share_0.01-0.09_2015_ggplot_en.png", width = 12, height = 6.75)
```
...
```{r, save.image}
# save.image(file = "US_top_income_shares_2015_add.rda")
```
-->
