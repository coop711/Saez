...
# library(xlsx)
library(knitr)
load("US_top_income_shares_vs_tax_rates.rda")
...
# US.income.averages.14 <- read.xlsx("../data/TabFig2014prel.xlsx", sheetIndex = 51, sheetName = "data-FigA1", startRow = 4, endRow = 105, colIndex = c(1:3, 5:6), header = FALSE)
...
names(US.income.averages.14) <- v.names
tax.rates <- read.table("../data/federal_income_tax_rates.txt", skip = 1, header = FALSE)
names(tax.rates) <- c("Year", "Lowest", "Marginal")
top.income_tax <- cbind(US.top.income.shares.14[c("Year", "P99_100")], US.income.averages.14[c("Bottom_99", "Top_1", "Bottom_99_K", "Top_1_K")], tax.rates[2:3])
Rate_99 <- US.income.averages.14[, "Bottom_99"]/US.income.averages.14[, "Bottom_99"][1]*100
Rate_1 <- US.income.averages.14[, "Top_1"]/US.income.averages.14[, "Top_1"][1]*100
Rate_99_K <- US.income.averages.14[, "Bottom_99_K"]/US.income.averages.14[, "Bottom_99_K"][1]*100
Rate_1_K <- US.income.averages.14[, "Top_1_K"]/US.income.averages.14[, "Top_1_K"][1]*100
