...
# US.top.income.shares.15 <- read.xlsx("../data/TabFig2015prel.xlsx", sheetIndex = 9, sheetName = "Table A3", startRow = 6, endRow = 107, colIndex = c(1:7, 9:13), header = FALSE)
# v.names <- read.xlsx("./data/TabFig2015prel.xlsx", sheetName = "Table A3", startRow = 4, endRow = 4, colIndex = c(2:7, 9:15), colClasses = character, header = FALSE)
...
# plot(x = US.top.income.shares.15$Year, y = US.top.income.shares.15$P99_100)
...
abline(h = seq(5, 25, by = 5), lty = 3)
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text <- c("99-100%: More than $442,900 (2015)", "95-99%:$180,500-$442,900", "90-95%:$124,810-$180,500")
