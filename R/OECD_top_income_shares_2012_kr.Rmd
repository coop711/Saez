...
OECD_shares_2012 <- data.frame(Country.kr, Top_1_shares, Top_10_shares, stringsAsFactors = FALSE)
...
# png(file = "../pics/OECD_Top_Income_Shares_72dpi_kr.png", width = 864, height = 504)
# png(file = "../pics/OECD_Top_Income_Shares_300dpi_kr.png", width = 1280, height = 747)
# par(mfrow = c(1, 2))
par(mfrow = c(1, 2), mai = c(1.0, 1.8, 0.8, 0.4) + 0.2)
par(family = "HCR Dotum LVT")
x1 <- barplot(Top_1_shares[o.top_1], horiz = TRUE, col = "cyan", axes = FALSE, names.arg = Country.kr[o.top_1], xlim = c(0, 25), space = 0.5, las = 1)
...
x10 <- barplot(Top_10_shares[o.top_10], horiz = TRUE, col = "greenyellow", axes = FALSE, names.arg = Country.kr[o.top_10], xlim = c(0, 60), space = 0.5, las = 1)
title.10 <- "상위 10% 소득점유율(%)"
title(main = title.10)
...
# dev.copy(png, file = "../pics/OECD_Top_Income_Shares_2012_kr.png", width = 960, height = 560)
# dev.off()
```
...
OECD_shares_2012$Country.order.1 <- factor(OECD_shares_2012$Country.kr, levels = Country.kr[o.top_1])
OECD_shares_2012$Country.order.10 <- factor(OECD_shares_2012$Country.kr, levels = Country.kr[o.top_10])
# str(OECD_shares_2012)
...
ggsave("../pics/OECD_Top_Income_Shares_2012_ggplot_kr.png", plot = g3, width = 12, height = 9)
```
-->
