...
```{r, partition top 10, echo = FALSE, fig.width = 12, fig.height = 6.75}
# png(file = "../pics/US_top_income_share_1-4-5_2014.png", width = 1280, height = 720)
...
main.title.1 <- "미국 소득 상위 10%의 점유율 분할"
...
# dev.copy(png, file = "../pics/US_top_income_share_1-4-5_2014.png", width = 1280, height = 720)
# dev.off()
```
...
소득 상위 1%(`P999_100`)를 상위 0.1%(`P99.9_100`), 차상위 0.4%(`P99.5_99.9`), 차차상위 0.5%(`P99_99.5`)로 분할

```{r, partiotion top 1, echo = FALSE, fig.width = 12, fig.height = 6.75}
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2014.png", width = 1280, height = 720)
...
legend(x = 1945, y = 25, legend = legend.text.2, pch = 17, col = c("black", "red", "blue"))
main.title.2 <- "미국 소득 상위 1%의 점유율 분할(0.1%-0.4%-0.5%)"
title(main = main.title.2)
text(x = c(1928, 2007), y = c(12, 12.5), labels = c("1928", "2007"), pos = 3)
times.label <- c("대공황", "대번영", "대침체")
text(x = c(1935, 1960, 2012), y = c(9, 2, 7.5), label = times.label, cex = 2.0, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_0.1-0.4-0.5_2014.png", width = 1280, height = 720)
# dev.off()
```
...
```{r, partiotion top 1 0.01 vs 0.99, echo = FALSE, fig.width = 12, fig.height = 6.75}
# png(file = "../pics/US_top_income_share_0.01-0.09_2014.png", width = 1280, height = 720)
plot(P99.99_100 ~ Year, data = US.top.income.shares.14, xlab = "연도", ylab = "소득점유(%)", ylim = c(0, 8), xaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2010, by = 10), labels = seq(1910, 2010, by = 10))
...
main.title.3 <- "미국 소득 상위 0.1%의 점유율 분할(0.01% vs 0.09%)"
title(main = main.title.3)
text(x = c(1928, 2007), y = c(6.5, 6.3), labels = c("1928", "2007"), pos = 3)
times.label <- c("대공황", "대번영", "대침체")
text(x = c(1935, 1960, 2012), y = c(5.6, 2.8, 3.0), label = times.label, cex = 2.0, col = "red")
# dev.print(png, file = "../pics/US_top_income_share_0.01-0.09_2014.png", width = 1280, height = 720)
# dev.off()
```
...
```{r, Top 10 percent, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75, fig.show = 'hide'}
source("./theme_kr.R")
library(ggplot2)
...
```{r, Top 1 percent, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75, fig.show = 'hide'}
...
```{r, Top 0.1 percent, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75, fig.show = 'hide'}
