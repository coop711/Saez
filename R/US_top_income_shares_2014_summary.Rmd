...
```{r, dev.copy.2}
dev.copy(png, file = "../pics/US_top_income_share_0.1-0.4-0.5_2014.png", width = 12, height = 6.75)
dev.off()
```
-->
...
```{r, dev.copy.3}
dev.print(png, file = "../pics/US_top_income_share_0.01-0.09_2014.png", width = 12, height = 6.75)
dev.off()
```
-->
...
(j11 <- j10 + 
   theme(legend.key = element_blank()))
(j12 <- j11 + 
   annotate("text", x = c(1928, 2007), y = c(6.5, 6.3), label = c(1928, 2007)))
(j13 <- j12 + 
