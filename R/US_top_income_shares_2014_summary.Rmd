...
소득 상위 10%(`P90_100`)의 소득점유율 변화 (1917 ~ 2014)

```{r, top 10, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 12, fig.height = 6.75}
# png(file = "../pics/US_top_income_share_10_2014_72dpi.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_10_2014_300dpi.png", width = 1280, height = 720)
x.lab <- "연도"
y.lab <- "소득점유율(%)"
plot(P90_100 ~ Year, data = US.top.income.shares.14, xlim = c(1910, 2020), ylim = c(30, 52), xaxt = "n", yaxt = "n", type = "b", pch = 17, ann = FALSE)
...
# legend.text <- "상위 90% : 연소득 $121,360 이상 (2014년 기준)""
# legend(x = 1944, y = 25, legend = legend.text.1, pch = 17, col = c("black", "red", "blue"))
main.title <- "미국 소득 상위 10%의 점유율 변화 (1917 ~ 2014)"
...
text(x = c(1935, 1965, 2015), y = c(48.5, 32, 46.5), label = times.label, cex = 1.6, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_10_2014.png", width = 960, height = 540)
# dev.off()
```
...
plot(P99_100 ~ Year, data = US.top.income.shares.14, xlim = c(1910, 2020), ylim = c(5, 25), xaxt = "n", type = "b", pch = 17, ann = FALSE)
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
lines(P95_99 ~ Year, data = US.top.income.shares.14, type = "b", pch = 17, col = "red")
lines(P90_95 ~ Year, data = US.top.income.shares.14, type = "b", pch = 17, col = "blue")
abline(h = seq(5, 25, by = 5), lty = 3)
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.1 <- c("99-100%:$423,090 이상(2014년 기준)", "95-99%:$174,240-$423,090", "90-95%:$121,360-$174,240")
legend(x = 1944, y = 25, legend = legend.text.1, pch = 17, col = c("black", "red", "blue"))
main.title.1 <- "미국 소득 상위 10%의 점유율 분할 (1913 ~ 2014)"
title(main = main.title.1, xlab = x.lab, ylab = y.lab)
text(x = c(1924, 2007), y = c(23.5, 23.5), labels = c("1928", "2007"), pos = 3)
times.label <- c("대공황", "대번영", "대침체")
text(x = c(1935, 1965, 2015), y = c(22, 8, 18), label = times.label, cex = 1.6, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_1-4-5_2014.png", width = 960, height = 540)
# dev.off()
```
...
plot(P99.9_100 ~ Year, data = US.top.income.shares.14, xlim = c(1910, 2020), ylim = c(0, 13), xaxt = "n", yaxt = "n", type = "b", pch = 17, ann = FALSE)
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
...
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.2 <- c("99.9-100%:$1,894,100 이상(2014년 기준)","99.5-99.9%:$646,550-$1,894,100","99-99.5%:$423,090-$646,550")
legend(x = 1943, y = 13, legend = legend.text.2, pch = 17, col = c("black", "red", "blue"))
main.title.2 <- "미국 소득 상위 1%의 점유율 분할 (1913 ~ 2014)"
title(main = main.title.2, xlab = x.lab, ylab = y.lab)
text(x = c(1924, 2007), y = c(11, 12.5), labels = c("1928", "2007"), pos = 3)
times.label <- c("대공황", "대번영", "대침체")
text(x = c(1935, 1965, 2015), y = c(10, 2, 8), label = times.label, cex = 1.6, col = "red")
# dev.copy(png, file = "../pics/US_top_income_share_0.1-0.4-0.5_2014.png", width = 960, height = 540)
# dev.off()
```
...
plot(P99.99_100 ~ Year, data = US.top.income.shares.14, xlim = c(1910, 2020), ylim = c(0, 7), xaxt = "n", type = "b", pch = 17, ann = FALSE)
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
lines(P99.9_99.99 ~ Year, data = US.top.income.shares.14, type = "b", pch = 17, col = "blue")
abline(h = seq(0, 6, by = 2), lty = 3)
abline(v = seq(1910, 2020, by = 10), lty = 3)
legend.text.3 <- c("99.99-100%:$9,497,900 이상(2014년 기준)","99.9-99.99%:$1,894,100-$9,497,900")
legend(x = 1942.5, y = 7, legend = legend.text.3, pch = 17, col = c("black", "blue"))
main.title.3 <- "미국 소득 상위 0.1%의 점유율 분할 (1913 ~ 2014)"
title(main = main.title.3, xlab = x.lab, ylab = y.lab)
text(x = c(1924, 2007), y = c(6.3, 6.3), labels = c("1928", "2007"), pos = 3)
times.label <- c("대공황", "대번영", "대침체")
text(x = c(1935, 1965, 2015), y = c(5.6, 0.5, 3.4), label = times.label, cex = 1.6, col = "red")
# dev.print(png, file = "../pics/US_top_income_share_0.01-0.09_2014.png", width = 960, height = 540)
# dev.off()
```
...
library(reshape2)
data.10.df <- US.top.income.shares.14[c("Year", "P90_100")]
...
# f6
f7 <- f6 + 
  annotate("text", x = c(1935, 1965, 2015), y = c(48.5, 32, 46.5), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
```

```{r, Top 10 percent share ggsave, warning = FALSE, echo = FALSE, fig.width = 12, fig.height = 6.75}
f7
# ggsave("../pics/US_top_income_share_10_2014_ggplot.png", width = 12, height = 6.75)
```
...
# g12
g13 <- g12 + 
  annotate("text", x = c(1935, 1965, 2015), y = c(22, 8, 18), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
```
...
# h12
h13 <- h12 + 
  annotate("text", x = c(1935, 1965, 2015), y = c(10, 2, 8), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
```
...
# j12
j13 <- j12 + 
  annotate("text", x = c(1935, 1965, 2015), y = c(5.6, 0.5, 3.5), label = times.label, colour = "red", family = "HCR Dotum LVT", size = 8)
```
