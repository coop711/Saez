...
text(x = c(1935, 1965, 2014), y = c(22, 8, 18), label = times.label, cex = 1.6, col = "red")
...
plot(P99.9_100 ~ Year, data = US.top.income.shares.14, xlab = "연도", ylab = "소득점유(%)", ylim = c(0, 13), xaxt = "n", yaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2010, by = 10), labels = seq(1910, 2010, by = 10))
...
legend(x = 1944, y = 13, legend = legend.text.2, pch = 17, col = c("black", "red", "blue"))
main.title.2 <- "미국 소득 상위 1%의 점유율 분할 (1913 ~ 2014)"
title(main = main.title.2)
text(x = c(1924, 2007), y = c(11, 12.5), labels = c("1928", "2007"), pos = 3)
times.label <- c("대공황", "대번영", "대침체")
text(x = c(1935, 1965, 2014), y = c(10, 2, 8), label = times.label, cex = 1.6, col = "red")
...
plot(P99.99_100 ~ Year, data = US.top.income.shares.14, xlab = "연도", ylab = "소득점유(%)", ylim = c(0, 7), xaxt = "n", type = "b", pch = 17)
axis(side = 1, at = seq(1910, 2010, by = 10), labels = seq(1910, 2010, by = 10))
...
legend(x = 1944, y = 7, legend = legend.text.3, pch = 17, col = c("black", "blue"))
...
times.label <- c("대공황", "대번영", "대침체")
text(x = c(1935, 1965, 2014), y = c(5.6, 0.5, 3.4), label = times.label, cex = 1.6, col = "red")
